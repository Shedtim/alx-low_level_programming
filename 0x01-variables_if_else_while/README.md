1 - This program will affect a random number to the variable n ech time it is executed. Complete the source code in order to print the last dig it of the number stored in the variable n. [Source code here]
